        ...
        <div class="story clearfix">
            <article class="clearfix">
                ...
                <div class="column left">
                    <img title="Featured episode thumbnail image" class="cushycms replace-2x rel" src="index_4_3238595408.jpg" alt="E11: Buddy Baseball" />
                    <nav class="clearfix">
                        <div class="social">
...
<a href="#" class="button next">&larr; Next Episode</a> <a href="#" class="button previous">Previous Episode &rarr;</a> </div>
	...
	<li>
</li><li><h6>Audio</h6><span>Zach Staas</span></li>
		<h6>
			Special Thanks</h6>
		<span>TBD</span><br />
		<br />
	...
	These stories are a response to the national attention Rockford, Illinois received in 2011: from Forbes, #9 Most Dangerous in US; from the Wall Street Journal, #10th Most Dangerous in US; New York Times, Portraits From a Job-Starved City; and Comedy Central&#39;s The Daily Show portrayed Rockford as a wasteland littered with chain fast food restaurants.</p>
        ...
        <div id="recent" class="recent clearfix">
            <article class="clearfix">
                ...
                <div title="Recent episode #1" class="column left cushycms"><a href="http://ourcityourstory.com/episode/5"><img class="replace-2x rel" src="img/e05-thumb.jpg" alt="E05: Handcuffs To Handshakes" /></a>
<h6>
	Episode 05</h6>
<h3>
...
<a href="http://ourcityourstory.com/episode/5" class="button">Watch &rarr;</a></div>
                <div title="Recent episode #2" class="column center cushycms"><a href="http://ourcityourstory.com/episode/4"><img class="replace-2x rel" src="img/e04-thumb.jpg" alt="E04: Darrell Hines" /></a>
<h6>
	Episode 04</h6>
<h3>
