    ...
    <div role="main">
        <div id="episode" class="episode">
            ...
            <div class="cushycms" title="Change the number after 'video/' but before '?'.">
                <iframe id="video" title="iframe for featured episode." src="http://player.vimeo.com/video/41536313?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff&amp;api=1&amp;player_id=video" width="500" height="281" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>
            </div>
        </div>
        ...
        <div class="story clearfix">
            <article class="clearfix">
                ...
                <div class="column left">
                    <img title="Featured episode thumbnail image" class="cushycms replace-2x rel" src="img/f6.jpg" height="221" alt="E6" width="316">
                    <nav class="clearfix">
                        <div class="social">
