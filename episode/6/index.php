        ...
        <div class="story clearfix">
            <article class="clearfix">
                ...
                <div class="column left">
                    <img class="cushycms replace-2x rel" title="Featured episode thumbnail image" src="img/f6.jpg" height="221" alt="E6" width="316">
                    <nav class="clearfix">
                        <div class="social">
