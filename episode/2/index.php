            ...
            <div class="story clearfix">
                <article class="clearfix">
                    ...
                    <div class="column left">
                        <img class="cushycms replace-2x rel" title="Featured episode thumbnail image" src="img/f2.jpg" height="221" alt="E2" width="316">
                        <nav class="clearfix">
                            <div class="social">
...
<p>JThe ivy-coated exterior of the Vince the Tailor shop appears to have been there for decades...and it has, but it is rooted deeper than North Main. Tony Chiarelli owns and operates this alterations and tailoring shop.&hellip;</p>
