    ...
    <body>
        ...
        <div role="main">
            <div id="episode" class="episode">
                ...
                <h1 title="Put this page's featured video ID here" class="invisible cushycms" id="video-id">43273531</h1>
            ...
            <div class="story clearfix">
                <article class="clearfix">
                    ...
                    <div class="column left">
                        <img title="Featured episode thumbnail image" class="cushycms replace-2x rel" src="img/f2.jpg" height="221" alt="E2" width="316">
                        <nav class="clearfix">
                            <div class="social">
