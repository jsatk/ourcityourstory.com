  ...
  <!--[if lt IE 7]><p class=chromeframe>Your browser is <em>ancient!</em> <a href="http://browsehappy.com/">Upgrade to a different browser</a> or <a href="http://www.google.com/chromeframe/?redirect=true">install Google Chrome Frame</a> to experience this site.</p><![endif]-->
    ...
    <div role="main">
        <div id="episode" class="episode">
            ...
            <h1 title="Put this page's featured video ID here" class="invisible cushycms" id="video-id">43470589</h1>
        ...
        <div class="story clearfix">
            <article class="clearfix">
                ...
                <div class="column left">
                    <img title="Featured episode thumbnail image" class="cushycms replace-2x rel" src="index_4_2117711153.jpg" alt="E11: Buddy Baseball" />
                    <nav class="clearfix">
                        <div class="social">
...
<li><h6>Audio</h6><span>Zach Staas</span></li>
	...
	Our Vision</h5>
<p>
	We tell the stories that if you live in Rockford, it makes you glad that you do. The stories that if you&#39;re from Rockford, they make you proud to be. The stories that if you&#39;re never been to Rockford, they make you want to come here.</p>
<h5 class="border">
	Our City</h5>
<p>
	These stories are a response to the national attention Rockford, Illinois received in 2011: from Forbes, #9 Most Dangerous in US; from the Wall Street Journal, #10th Most Dangerous in US; New York Times, Portraits From a Job-Starved City; and Comedy Central&#39;s The Daily Show portrayed Rockford as a wasteland littered with chain fast food restaurants.</p>
        ...
        <div id="recent" class="recent clearfix">
            <article class="clearfix">
                ...
                <div title="Recent episode #1" class="column left cushycms"><a href="http://ourcityourstory.com/episode/7"><img class="replace-2x rel" src="img/e07-thumb.jpg" alt="E07: Hometown History" /></a>
<h6>
	Episode 07</h6>
<h3>
...
<a href="http://ourcityourstory.com/episode/7" class="button">Watch &rarr;</a></div>
                <div title="Recent episode #2" class="column center cushycms"><a href="http://ourcityourstory.com/episode/6"><img class="replace-2x rel" src="img/e06-thumb.jpg" alt="E06: Bonds By Fire" /></a>
<h6>
	Episode 06</h6>
<h3>
