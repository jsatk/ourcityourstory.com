<!doctype html>
    ...
    <div role="main">
        <div id="episode" class="episode">
            <h1 title="Featured video title" class="cushycms">Darrell Hines</h1>
            ...
            <h1 title="Put this page's featured video ID here" class="invisible cushycms" id="video-id">43276392</h1>
            ...
            <div class="cushycms" title="Change the number after 'video/' but before '?'."><iframe title="iframe for featured episode." mozallowfullscreen="" src="http://player.vimeo.com/video/43276392?title=0&amp;byline=0&amp;portrait=0&amp;color=ffffff&amp;api=1&amp;player_id=video" allowfullscreen="" id="video" height="281" webkitallowfullscreen="" width="500"></iframe></div>
        </div>

        <div class="story clearfix">
            <article class="clearfix">
                <h5>Our City, Our Story</h5>
                <h4 title="Featured episode title. Must begin with 'E##'" class="cushycms">E04: Darrell Hines</h4>
                <div class="column left">
                    <img class="thumb replace-2x rel" src="" alt="Featured Episode Thumbnail">
                    <nav class="clearfix">
                        <div class="social">
                            <div class="fb-like" data-href="http://ourcityourstory.com/episode/4/" data-send="false" data-layout="button_count" data-width="450" data-show-faces="false"></div>
                        </div>
	...
	<li>
        ...
        <div id="recent" class="recent clearfix">
            <article class="clearfix">
                ...
                <div title="Recent episode #1" class="column left cushycms"><a href="http://ourcityourstory.com/episode/3/#episode"><img class="replace-2x rel" src="img/e03-thumb.jpg" alt="E03: Pioneer of the Past" /></a>
<h6>
	Episode 03</h6>
<h3>
...
<a href="http://ourcityourstory.com/episode/2/#episode" class="button">Watch &rarr;</a></div>
                <div title="Recent episode #3" class="column right cushycms"><a href="http://ourcityourstory.com/episode/1/#episode"><img class="replace-2x rel" src="img/e01-thumb.jpg" alt="E01: The Torchlighter" /></a>
<h6>
	Episode 01</h6>
<h3>
