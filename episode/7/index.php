<!doctype html>
    ...
    <div role="main">
        <div id="episode" class="episode">
            ...
            <h1 class="invisible cushycms" title="Put this page's featured video ID here" id="video-id">43276390</h1>
        ...
        <div class="story clearfix">
            <article class="clearfix">
                ...
                <div class="column left">
                    <img class="cushycms replace-2x rel" title="Featured episode thumbnail image" src="img/f7.jpg" height="221" alt="E7" width="316">
                    <nav class="clearfix">
                        <div class="social">
