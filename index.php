    ...
    <body>
        ...
        <div role="main">
            <div id="episode" class="episode">
                ...
                <a href="" class="controls next"><em>&#8592;</em><span title="Next Episode" class="cushycms"></span></a>
            ...
            <div class="story clearfix">
                <article class="clearfix">
                    ...
                    <div class="column left">
                        <img title="Featured episode thumbnail image" class="cushycms replace-2x rel" src="img/f11.jpg" alt="E11: Buddy Baseball" width="316" height="221">
                        <nav class="clearfix">
                            <div class="social">
                    ...
                    <div title="Feature episode description" class="column clearfix center cushycms">
                        ...
                        <a href="#" class="button next">&larr; Next Episode</a> <a href="#" class="button previous">Previous<span class="cut"> Episode<span> &rarr;</a>
                    </div>
            ...
            <div id="recent" class="recent clearfix">
                <article class="clearfix">
                    ...
                    <div title="Recent episode #1" class="column left cushycms">
                    ...
                    <div title="Recent episode #3" class="column right cushycms"><a href="http://ourcityourstory.com/episode/8">
